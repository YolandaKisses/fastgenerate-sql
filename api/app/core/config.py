...
class Settings(BaseSettings):
    ...
    RAG_RETRIEVAL_BACKEND: str = "local"
    LIGHTRAG_BASE_URL: str = ""
    LIGHTRAG_API_KEY: str = ""
    LIGHTRAG_TIMEOUT_SECONDS: int = 20
    LIGHTRAG_HEALTH_PATH: str = "/health"
    LIGHTRAG_SEARCH_PATH: str = "/search"
    LIGHTRAG_ASK_PATH: str = "/ask"
    LIGHTRAG_REBUILD_PATH: str = "/indexes/rebuild"
    LIGHTRAG_UPSERT_PATH: str = "/indexes/upsert"
    LIGHTRAG_DELETE_PATH: str = "/indexes/delete"
    LIGHTRAG_ENABLE_REMOTE_REBUILD: bool = False
    LIGHTRAG_ENABLE_REMOTE_ASK: bool = False
